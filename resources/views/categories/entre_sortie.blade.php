<x-nav-bar>
    ...
    <div class="flex w-2/3 justify-around">
        ...
        <form id="deleteForm" method="POST">
            ...
            <button type="submit" class="bg-red-500 text-white p-2 rounded-sm hover:scale-110 hover:bg-red-400">confirmer</button>
        </form>
    </div>
</div>
<div class="text-sm font-medium text-center text-gray-500  border-gray-200 dark:text-gray-400 dark:border-gray-700" id='cont'>
    <ul class="flex flex-wrap -mb-px">
        ...
        <li class="me-2">
            <a href="{{ route('categories.entre_sortie', $categories) }}"  class="inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" aria-current="page">  Tous</a>
        </li> 
        <li class="me-2">
...
<script>
    function warnning(id, type) {
            ...
            document.getElementById('message').action = type === 'entre' ? 'retirer' : 'rajouter';
