            ...
            <div class="mx-4">
                <div class="bg-gray-50 border border-gray-200 shadow-md p-10 rounded max-w-lg mx-auto mt-24">
                    ...
                    <form action="{{ route('entres.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <label for="date_doc" class="inline-block text-lg mb-2">remise</label>
                            <input type="date" class="border border-gray-200 rounded p-2 w-full" name="remise" id="date_doc" />
                            @error('date_doc')
                                <p class="text-red-500 test-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
