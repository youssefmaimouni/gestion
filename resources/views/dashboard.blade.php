    ...
    <div class="py-12">
        <div class=" mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden gap-2 grid grid-cols-2 justify-items-center">
                ...
                <a class="h-52 w-full bg-slate-400 m-3 flex items-center flex-col   text-center justify-center" href="/clients">
                    <svg enable-background="new 0 0 91 91" height="100px" id="Layer_1" version="1.1"
                        viewBox="0 0 91 91" width="100px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g>
                            <path
                ...
                <a class="h-52 w-full bg-slate-400 m-3 flex items-center flex-col   text-center justify-center"
                    href="/fournisseurs">
